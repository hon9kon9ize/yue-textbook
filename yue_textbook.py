...
NODRVPN_SERVICE_USERNAME = quote('###')
NODRVPN_SERVICE_PASSWORD = quote('###')
socks5_proxy = f'socks5://{NODRVPN_SERVICE_USERNAME}:{NODRVPN_SERVICE_PASSWORD}@atlanta.us.socks.nordhold.net:1080'
